...
$limit=2;
$offset=$limit*($page-1);
$total_pages=round(countRow('film_overview')/$limit,0);
$films=selectAllPostIndex('film_overview','films',$limit,$offset);
?>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<main id="main">
    ...
    <section class="catalog ">
        <div class="catalog-wrapper">
            ...
            <!--
            Делаем просто составной get запрос
            <=BASE_URL.'overview_page.php?iid=123'.'&film='.$film['id_film'];?>
            --->
                    ...
                    <div class="swiper-slide catalog-card card-main">
                        <div class="item">
                            <div class="card-image">
                                <div class="card-bg">
                                    ...
                                    <div class="card-bg__upbg">
                                        <a href='<?=BASE_URL.'overview_page.php?&overview='.$film['id'];?>' class="card-bg__play">
                            ...
                            <h2 class="card-main--title">
                                <a href="<?=BASE_URL.'overview_page.php?&overview='.$film['id'];?>">
                                    <?=$film['title'];?>
                                </a>
                            </h2>
                        </div>
