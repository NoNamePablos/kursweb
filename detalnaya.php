  ...
  <?php include('app/includes/header.php');?>
    <main id="main">
      <div class="detfilm-container container">
        <div class="detfilm">
                <aside class="detfilm-aside">
                    <div class="detfilm-aside--wrapper">
                        <div class="detfilm-card swiper-slide card-main">
                            <div class="item">
                    ...
                    <a class="detfilm-button detfilm-button--add "href="detalnaya.php?fav=<?=$film['id_film'];?>">
                ...
                <div class="detfilm-comments">
                    <div class="comment-wrapper">
                        <form action="" method="post" class="comment-form">
                                ...
                                <textarea name="comment" class="comment-area" id="" cols="30" rows="10"></textarea>
                                <button class="btn comment-btn"><span>Отправить</span></button>
                        </form>
                                ...
                                <div class="comment-item">
                                    <div class="comment-item--header">
                                        <div class="comment-item--login">
                                            ...
                                            <time class="comment-item--datetime">
                                                <time datetime="Thu Dec 30 2021 06:14:50 GMT+0300 (Москва, стандартное время)">6 дней назад</time>
                                            </time>
                                        </div>
                                    ...
                                    <div class="comment-item--content">
                                        <span class="comment-item-text">
                                            fadsfsafasf fadsfsafasf fadsfsafasf fadsfsafasf fadsfsafasf fadsfsafasf fadsfsafasf
                                        </span>
                                    </div>
                                </div>
