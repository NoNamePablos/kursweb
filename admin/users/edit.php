...
<main id="main " >
    ...
    <div class="admin-wrapper">
        ...
        <section class="admin-add--wrapper">
            <form action="edit.php" method="post" class="reset-form">
                <input type="hidden" class="input-setting-field" name="id" value="<?=$id;?>" ">
                <div class="header-second--search input input-setting">
                    <input type="text" class="input-setting-field" name="login" placeholder="Логин" value="<?=$username?>">
                </div>
                <div class="header-second--search input input-setting">
                    <input type="text" class="input-setting-field"  name="email" placeholder="email " readonly value="<?=$email?>">
                </div>
                ...
                <input  type="submit" name="update-user" class="btn-submit  btn header-second-user--login" value="Обновить">
