...
<main id="main " >
    ...
    <div class="admin-wrapper">
        ...
        <section class="admin-add--wrapper">
            <form action="create.php" method="post" class="overview-form reset-form">
                <div class=" overview-form-title form-group mb-3">
                    <label for="over-title">Название статьи</label>
                    <input type="text" class="form-control"  name="over-titles" id="over-title" placeholder="Название статьи">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group">
                    <textarea class="form-control" id="editor" name="over-content" rows="3"></textarea>
                </div>
                ...
                <input  type="submit" name="create-overview" class="btn-submit  btn header-second-user--login" value="Добавить">
